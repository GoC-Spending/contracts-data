...
contract_spending_overall <- contracts %>%
  ...
  select(d_reference_number, d_vendor_name, d_start_date, d_end_date, contract_value, d_amendment_group_id, owner_org, d_number_of_amendments, economic_object_code, description_en, comments_en, additional_comments_en) %>%
